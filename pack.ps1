...
$nugetPath = "$workingDirectory\src\Alloy.Sample\Advanced.CMS.Forms.nuspec"
$moduleName = "advanced-cms-forms"
...
Set-Location src\Alloy.Sample\modules\_protected\$moduleName
